...
# ./llmtrain.sh --do_train --stage sft --name=0108_glm4_edg_acfvcaulsd_markdown_ep2_lr2e4_bs4 --model_name_or_path /opt/nas/n/zhubin/DATA/models/THUDM/glm-edge-4b-chat --template glm4edge \
...
./llmtrain.sh --do_train --stage sft --name=TEST --model_name_or_path /opt/nas/n/zhubin/DATA/models/THUDM/glm-edge-4b-chat --template glm4edge \
