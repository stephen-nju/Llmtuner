...
###运行训练时需要先进行配置
export DATASET="baichuan_30w,cls_headlines,vcsum_headlines,firefly_summary_part,COIG_PC_core_summary_part,conversation_abstract_v1_part0"

# export DATASET="cls_headlines"
export WANDB_PROJECT="HONOR_CHAT_2.5B"
export WANDB_NAME="honor_2.5b_conv_abstract_v2_lora64_lr6e5_3epoch_bs4"
...
wandb offline
deepspeed --hostfile=${OUTPUT_DIR}/hostfile --include="node7:0,1,2,3,4,5,6,7" --master_port=${MASTER_PORT}  --no_local_rank \
	src/train_bash.py \
